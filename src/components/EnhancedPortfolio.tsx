        ...
        <div className="flex justify-between items-center">
          ...
          <ul className={`md:flex items-center gap-4 text-zinc-400 ${isMenuOpen ? 'block absolute top-full left-0 right-0 bg-black/80 p-4 md:p-0 md:relative md:bg-transparent' : 'hidden'}`}>
            ...
            <li className="md:ml-4">
              <motion.a
                href="https://drive.google.com/file/d/1y3N9B-R6nRqInO0aPHRnsY8hrkg-kJ7C/view?usp=drivesdk"
                target="_blank"
    ...
    >
      {isLoading ? (
          ...
          <main className="container mx-auto px-4 py-20">
            <section id="home" className="min-h-screen flex items-center justify-center py-20 relative">
              ...
              >
                ...
                >
                  {[
                    { icon: Github, href: 'https://github.com/rhm856591', label: 'GitHub' },
                    { icon: Linkedin, href: 'https://www.linkedin.com/in/rahamtullah-sheikh-792497205/', label: 'LinkedIn' },
                    { icon: Code2, href: 'https://leetcode.com/u/sheikh856591/', label: 'LeetCode' },
                    { icon: Mail, href: 'mailto:sheikh856591@gmail.com', label: 'Email' }
                  ].map((social, index) => (
                    <motion.a
                      key={index}
                      href={social.href}
                  ...
                  <div className="font-mono space-y-4 text-zinc-300">
                    <div className="typing-effect">
                      <div className="flex gap-4 items-center hover:bg-zinc-800/50 p-2 rounded transition-colors">
                        ...
                        <span>
                          Hi! I'm <span className="text-green-500 font-semibold">Rahamtullah Sheikh</span>,
                      ...
                      <div className="flex gap-4 items-center hover:bg-zinc-800/50 p-2 rounded transition-colors">
                        ...
                        <span>
                          Committed to <span className="text-yellow-500">continuous learning</span> and staying ahead in <span className='text-blue-400'>technology trends</span>.
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <Window title="skills.json">
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {['NextJs', 'MongoDB', 'FastAPI', 'React', 'Tailwind', 'Mongoose', 'NodeJs', 'Express'].map(skill => (
                            <motion.span
                              key={skill}
                              whileHover={{ scale: 1.05 }}
                              className="px-3 py-1.5 bg-zinc-800/70 rounded-lg text-sm text-zinc-300 hover:bg-zinc-700/70 transition-colors cursor-default"
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-3">
                          {['AWS', 'Docker', 'Jenkins', 'Git', 'CI/CD', 'kubernetes'].map(skill => (
                            <motion.span
                              key={skill}
                              whileHover={{ scale: 1.05 }}
                              className="px-3 py-1.5 bg-zinc-800/70 rounded-lg text-sm text-zinc-300 hover:bg-zinc-700/70 transition-colors cursor-default"
                  ...
                  {[
                    {
                      ...
                      year: '2024',
                      tech: ['Vite', 'React.Js', 'Tailwind CSS', 'GitHub API', 'Javascript'],
                      description: 'A fully responsive and developed a web application that interacts with GitHub’s public API to fetch and display user and repository data.'
                    },
                    {
                      id: '02',
                      title: 'Zagrad E-Commerce Website',
                      year: '2023',
                      tech: ['Next.Js', 'React.Js', 'Node.Js', 'MongoDB', 'Shadcn'],
                      description: 'Engineered and developed a fully functional Zagrad e-commerce website using Next.js, HTML, CSS, and JavaScript, ensuring seamless user experience and optimal performance'
                    },
                    {
                      id: '03',
                      title: 'Nazim Overseas',
                      year: '2022',
                      tech: ['HTML', 'CSS', 'Javascript', 'Node.Js'],
                      description: 'Redesigned and implemented a website overhaul for Nazim Overseas using HTML, CSS, and JavaScript during a Web Developer Internship from November 2022 to January '
                    }
                  ].map((project) => (
                    <motion.div
                      key={project.id}
        ...
        hover:bg-zinc-700 transition-colors duration-300 border border-green-500/20"
                >
                  <FileText className="w-4 h-4" />
                  <span className="font-mono text-sm">Rahamtullah_Sheikh_Resume.pdf</span>
                </motion.a>
              </div>
                ...
                <div className="space-y-12 px-5">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-green-500 font-mono text-sm">Nov 2022 - Jan 2023</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className={`font-semibold ${isDarkMode ? 'text-zinc-300' : 'text-gray-700'}`}>Nazim Overseas</span>
                      ...
                      <ul className="space-y-3 text-zinc-400">
                        <li className="flex gap-2">
                          ...
                          <span>Redesigned and implemented a website overhaul for improved performance and user experience.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-green-500">→</span>
                          <span>Optimized the website, reducing load speed by 40% and increasing online sales by 25%.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-green-500">→</span>
                          <span>Implemented responsive design principles, increasing mobile conversions by 40%.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-green-500">→</span>
                          <span>Maintained the live website at <a target='_blank' href="https://nazimoverseas.netlify.app/" className="underline">nazimoverseas.netlify.app</a>.</span>
                        </li>
                      </ul>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <span className="text-blue-500 font-mono text-sm">Jul 2024 - Aug 2024</span>
                      <ul className="space-y-3 text-zinc-400">
                        <li className="flex gap-2">
                          <span className="text-blue-500">→</span>
                          <span>Developed a web application to fetch and display user/repository data using GitHub's API.</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="text-blue-500">→</span>
                          <span>Implemented real-time data fetching using React.js and JavaScript.</span>
                        </li>
                      </ul>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-zinc-500">•</span>
                        <span className="text-zinc-500">Chandigarh, India</span>
                      </div>
                      <div className="text-zinc-400">
                        <span className="text-purple-500 font-semibold">CGPA:</span> 7.5/10.0
                      </div>
                    </div>
                  </motion.div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Window title="me-online.sh">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {[
                        { icon: Mail, label: 'sheikh856591@gmail.com', href: 'mailto:sheikh856591@gmail.com' },
                        { icon: Phone, label: '+91 7905723844', href: 'tel:+917905723844' },
                    ...
                    <div className="pt-4 border-t border-zinc-800">
                      <div className="space-y-4">
                        {[
                          { icon: Github, label: 'github.com/rhm856591', href: 'https://github.com/rhm856591' },
                          { icon: Linkedin, label: 'linkedin.com/in/rahamtullah-sheikh', href: 'https://www.linkedin.com/in/rahamtullah-sheikh-792497205/' },
                          { icon: Code2, label: 'leetcode.com/sheikh856591', href: 'https://leetcode.com/u/sheikh856591/' },
                        ].map((social, index) => (
                          <motion.div
                            key={index}
                            whileHover={{ x: 4 }}
